...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, width=\linewidth]{derivQuant.pdf}  
\end{figure}
\end{center}
\end{frame}
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=0.4]{U_bias.pdf}  
\end{figure}
\end{center}
\end{frame}
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, width=\linewidth]{SBiomass.pdf}  
\end{figure}
\end{center}
\end{frame}
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, width=\linewidth]{RecDev_bias.pdf}  
\end{figure}
\end{center}
\end{frame}
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, width=\linewidth]{sel_Contrast.pdf}  
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=0.32]{sel_OneWayTrip.pdf}  
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=0.32]{sel_Uramp.pdf}  
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=0.32]{sel_Contrast_timeVarSel.pdf}  
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=0.32]{sel_OneWayTrip_timeVarSel.pdf}  
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=0.32]{sel_Uramp_timeVarSel.pdf}  
		\caption{Derived selectivity for scenario: base-timeVarSel}
\end{figure}
\end{center}
\end{frame}
