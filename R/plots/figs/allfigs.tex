...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=0.32]{sel_base.pdf}  
		\caption{Derived selectivity for scenario: base}
\end{figure}
\end{center}
\end{frame}
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=0.32]{sel_base_timeVarSel.pdf}  
...
\begin{figure}               
		...
		\caption{Derived selectivity for scenario: OneWayTrip}
\end{figure}
\end{center}
\end{frame}
...
\begin{center} %left bottom right top,
\begin{figure}               
                \includegraphics[trim= 0mm 0mm 0mm 0mm, scale=0.32]{sel_Uramp_timeVarSel_.pdf}  
		\caption{Derived selectivity for scenario: base-timeVarSel}
\end{figure}
\end{center}
\end{frame}
