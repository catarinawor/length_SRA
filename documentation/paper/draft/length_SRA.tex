...
\tableEq
    \begin{align}
           \hline
            ...
            &\mbox{$wt$ = Normally distributed recruitmenet deviations} &\nonumber\\
        ...
        &\mbox{Age-schedule information} \nonumber \\ \nonumber \\
            ...
            SB_{t}&= \sum_a(fec_a \cdot w_a \cdot N_{a,t})
            \nonumber \\
        \hline \hline \nonumber
    \end{align}
    \normalEq
...
The model estimates three main parameters: the average unexploited recruitment $R_0$, teh recruiment compensation ratio $k_rec$  and the recruitment in the initial year $R_init $. In addition, the recruitment deviations are estimated for all cohorts observed in the model, that is, the number of recruitment deviations is equal to the number of years in the time series plus the number of age classes greater that recruitment age. 
...
We tested the model perfomance under three exploitation rates trajectories. The first exploitation rate trajectoty is the contrast trajectory. U is 


In order to test the performance of the model under a known  
Three 
