    ...
    \begin{align}
        ...
        %\hline \nonumber \\ 
           ...
           \hline
            ...
            \hline
            \label{PD2.1}
             N_{a,t>syr}&=\begin{cases} \frac{a_{rec} \cdot SB_{t-1}}{1+ b_{rec} \cdot SB_{t-1}} \cdot e^{wt}, &\quad a=1  \\\\
            %
            N_{a-1,t-1}\cdot S \cdot(1-U_{a-1,t-1}),&\quad 1<a<A  \\\\
            %
...
\hline
  $l$ & $\{1,2,...L\}$ &Central point of length bin, $L=15$\\
  $a$ & $\{1,2,...A\}$ &Age-class, $A=10$\\  
  $t$ & $\{1,2,...T\}$ &Annual time step, $T=50$\\
...
$wt$& $\mathcal{N}(0,\sigma_{rec})$ &  Recruitment deviations \\
