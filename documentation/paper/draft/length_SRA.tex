...
$\widehat{sel_{l,t}} $ && Resulting selectivity estimates at length and time \\
\hline
\hline
\end{tabular}
\end{table}
...
$\widehat{sel_{a,t}}$&& Vulnerability at age and time t \\
...
\tableEq
    \begin{align}
           \hline
            ...
            \label{OM2}          
            C^{Sim}_{l,t}&= N^{Sim}_{l,t} \cdot  U_{l,t} \cdot P_{l|a} \cdot \tau \\
            \label{OM3}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=.85,width=\textwidth]{Figure5.pdf}
